...
const buttonSecondaryEl = document.getElementById("btn-secondary");
...
function increment() {
  ...
  buttonSecondaryEl.style.backgroundColor = "rgb(62, 167, 132)";
}
...
function save() {
  ...
  count = 0;
  buttonSecondaryEl.style.backgroundColor = "blue";
}
